...
<table border=1 bgcolor="white" align="center">
    <tr>
        <th colspan=13 class="titulos"><b>LIBRO POR OPERADOR: <?php echo $generador; ?></b></th>
    </tr>
    <tr>
    ...
    while ($fila = mysqli_fetch_array($consulta)) { ?>
        <tr>
            ...
            <td class="titulos3"><?php echo $fila['estado_det_manif']; ?></td>
