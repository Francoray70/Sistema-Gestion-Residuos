...
<div class="container w-85 border p-4 mt-5">
    ...
    <form action="{{url('/opdispfinal')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tel_odf" data-mask="(000)000-000000" class="form-control w-75" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email_odf" class="form-control w-75" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
        </div>
        <div class="mb-3">
