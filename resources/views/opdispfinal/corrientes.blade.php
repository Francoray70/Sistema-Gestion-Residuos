...
<div class="container w-85 border p-4 mt-5">
    ...
    <form action="{{url('/corrientesopdispfinal')}}" method="post">
        @csrf
        <div class="mb-3">
            <label class="form-label">Operadora de disposicion final</label>
            <select class="form-select w-75" name="id_oper_df" required>
        ...
        <a href="{{url('/listacantidadesanualesOdf')}}"><button type="button" class="btn btn-primary">Cantidad anual</button></a>
    </form>
</div>
