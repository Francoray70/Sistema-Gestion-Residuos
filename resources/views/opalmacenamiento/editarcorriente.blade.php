...
<div class="container w-85 border p-3 mt-5">
    ...
    <form action="{{ url('/corrientesopalmacenamiento/'.$id->id)}}" method="post">
        @method('PATCH')
        @csrf
        <table class="table table-light mt-4 w-85">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="text" class="form-control w-75" required value="{{$id->id_generador}}" name="id_generador" readonly></td>
                    <td>
